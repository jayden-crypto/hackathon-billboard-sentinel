...
# Import new hackathon modules - temporarily commented out for debugging
...
# Initialize security components - temporarily commented out for debugging
...
# Mount uploads first to avoid conflicts
app.mount("/uploads", StaticFiles(directory=uploads_dir), name="uploads")
app.mount("/static", StaticFiles(directory=static_dir), name="static")

# Initialize components - temporarily simplified for debugging
try:
    init_db()
...
# New API endpoints for hackathon features - temporarily commented out for debugging
